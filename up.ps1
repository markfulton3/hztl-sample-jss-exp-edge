...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.newproject.localhost/ --auth https://id.newproject.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.newproject.localhost/ --auth https://id.newproject.localhost/ --allow-write true
}
...
Start-Process https://cm.newproject.localhost/sitecore/
Start-Process https://www.newproject.localhost/
