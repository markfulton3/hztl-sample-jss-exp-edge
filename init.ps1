...
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.newproject.localhost"
}
Add-HostsEntry "cm.newproject.localhost"
Add-HostsEntry "id.newproject.localhost"
Add-HostsEntry "www.newproject.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.newproject.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.newproject.localhost"
    }


    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.newproject.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.newproject.localhost"
